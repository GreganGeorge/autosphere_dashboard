...
const Users = () => {
    ...
    const getData = async () => {
        const url = `http://localhost:5059/api/AdminUser/Get10`;
        try {
          ...
          <table className='min-w-full divide-y divide-gray-700'>
            <thead>
              <tr>
                ...
                <th className='px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase tracking-wider'>Location</th>
              </tr>
            </thead>
